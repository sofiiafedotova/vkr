...
Структура GitHub соответствует структуре выпускной квалификационной работы: в папке "Кластеризация TF-IDF" опубликованы материалы для воспроизводимости результатов Главы II "Кластерный анализ текстов", во папке "Кластеризация категориальных признаков -- главы III "Анализ категориальных признаков".
